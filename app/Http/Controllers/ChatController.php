...
class ChatController extends Controller
{
     ...
     * Buat session baru jika belum ada cookie.
     */
    public function index(Request $request)
    {
        ...
        return response()
            ...
            ->cookie('bio_session', $token, 60 * 24 * 7); // simpan 7 hari
    }

    /**
     * Terima pesan dari user, lempar ke ChatService, kembalikan JSON.
     */
    ...
    /**
     * Hapus semua pesan dalam session aktif.
     */
